       ...
       MenuAddEntryReal(emtSizeXLabel,
        ...
        MenuAddSeparator();
         ...
         MenuAddEntryReal(prtStartSizeXLabel,
            &PrtData.emtPtrSize->prtStartSize.x,
            NULL,
            0,
            5.0f,
            0.1f);
         ...
         MenuAddEntryReal(prtStartSizeYLabel,
            &PrtData.emtPtrSize->prtStartSize.y,
            NULL,
            0,
            5.0f,
            0.1f);
         ...
         MenuAddEntryReal(prtStartSizeBiasXLabel,
            &PrtData.emtPtrSize->prtStartSizeBias.x,
            NULL,
            0,
            5.0f,
            0.1f);
         ...
         MenuAddEntryReal(prtStartSizeBiasYLabel,
            &PrtData.emtPtrSize->prtStartSizeBias.y,
            NULL,
            0,
            5.0f,
            0.1f);
         ...
         MenuAddEntryReal(prtEndSizeXLabel,
            &PrtData.emtPtrSize->prtEndSize.x,
            NULL,
            0,
            5.0f,
            0.1f);
         ...
         MenuAddEntryReal(prtEndSizeYLabel,
            &PrtData.emtPtrSize->prtEndSize.y,
            NULL,
            0,
            5.0f,
            0.1f);
         ...
         MenuAddEntryReal(prtEndSizeBiasXLabel,
            &PrtData.emtPtrSize->prtEndSizeBias.x,
            NULL,
            0,
            5.0f,
            0.1f);
         ...
         MenuAddEntryReal(prtEndSizeBiasYLabel,
            &PrtData.emtPtrSize->prtEndSizeBias.y,
            NULL,
            0,
            5.0f,
            0.1f);

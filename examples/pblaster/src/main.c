...
CreateCamera(RpWorld *world)
{
    ...
    if( camera )
    {
        ...
        RwFrameTranslate(camFrame,&camPos,rwCOMBINEREPLACE);
...
Initialize(void)
{
    if( RsInitialize() )
    {
        ...
        RsGlobal.appName = RWSTRING("RenderWare Graphics Blaster Example");
...
Initialize3D(void *param)
{
     ...
     * Load The BSP...
     */
    LightDirectional = CreateDirectionalLight(World);
    if( LightDirectional == NULL )
    {
        RsErrorMessage(RWSTRING("Cannot create direcitonal light."));
    ...
    if( !BlasterCreate() )
    {
        RsErrorMessage(RWSTRING("Cannot create blaster."));
...
Terminate3D(void)
{
    ...
    if( LightDirectional )
    {
        RwFrame *frame = RpLightGetFrame(LightDirectional);
...
DisplayOnScreenInfo(void)
{
    ...
    {
        case BS_STATE_IDLE:
            RsSprintf(caption, RWSTRING("Blaster Status: Idle         "));
            break;
        case BS_STATE_PRECHARGING:
            RsSprintf(caption, RWSTRING("Blaster Status: PreCharging  "));
            break;
        case BS_STATE_CHARGING:
            RsSprintf(caption, RWSTRING("Blaster Status: Charging     "));
            break;
        case BS_STATE_DISCHARGING:
            RsSprintf(caption, RWSTRING("Blaster Status: DisCharging  "));
            break;
        case BS_STATE_SUPERCHARGING:
            RsSprintf(caption, RWSTRING("Blaster Status: SuperCharging"));
            break;
        case BS_STATE_CHARGED:
            RsSprintf(caption, RWSTRING("Blaster Status: Charged      "));
            break;
        case BS_STATE_FIRED:
            RsSprintf(caption, RWSTRING("Blaster Status: Firing       "));
            break;
        default:
            RsSprintf(caption, RWSTRING("Blaster Status: Unkwown      "));
            break;
    }

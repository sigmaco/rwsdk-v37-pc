...
Initialize(void)
{
    if( RsInitialize() )
    {
        ...
        RsGlobal.appName = RWSTRING("RenderWare Graphics 3D Immediate Mode Lighting Example");
 ...
 */
static RwBool
LightModeCallback(RwBool testEnable)
{
    if( testEnable )
    {
        return TRUE;
...
InitializeMenu(void)
{
    static RwChar lightModeLabel[] = RWSTRING("Lighting_L");
    static RwChar shadeModeLabel[] = RWSTRING("Shading_S");

    static RwChar fpsLabel[] = RWSTRING("FPS_F");
    
    static const RwChar *lightModeStrings[NUMLIGHTMODES] =
    {
    ...
    static const RwChar *shadeModeStrings[NUMSHADEMODE] =
    {
        RWSTRING("Gouraud"),
        RWSTRING("Flat"),
    };
    ...
    {
        MenuAddEntryInt(lightModeLabel, &LightMode, LightModeCallback,
            0, NUMLIGHTMODES - 1, 1, lightModeStrings);

        MenuAddEntryInt(shadeModeLabel, &ShadeMode, NULL,
            0, NUMSHADEMODE - 1, 1, shadeModeStrings);
